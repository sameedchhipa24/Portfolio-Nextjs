    ...
    <div className="relative h-[40rem] overflow-hidden flex items-center justify-center">
      <div className="w-full max-w-7xl mx-auto flex flex-col items-center justify-center h-full">
        ...
        <p className="text-base md:text-lg text-white text-center mb-4">
          Our free web development consultation service can guide you in the
          right direction for your project.
        </p>
        {/* eslint-disable-next-line react/no-unescaped-entities */}
        <p>
          {" "}
          We'll listen to your project requirements and provide you with the
          best and tailored solutions. Contact us today for your next big
          project!
        </p>
